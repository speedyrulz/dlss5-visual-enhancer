...
from ..gpu_detection import query_free_vram_mb
...
def resolve_video_gpu(
    ...
    if gpu_uuid != "auto":
        ...
        # Prefer a card other than the AI processing GPU when it has room, so
        # NVENC does not compete with the DLSS render for memory bandwidth.
